...
contract DSCEngine is ReentrancyGuard {
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); // I don't think this would ever occur since we're burning debt
    }

    // If we start nearing undercollateralization, we need someone to liquidate our position
        ...
        nonReentrant
    {
        ...
        //Incentivice them with a 10% bonus
        //Meaning $110 of WETH for 100 DSC given to the liquidator
    ...
    function getTokenAmountFromUsd(address token, uint256 usdAmountInWei) public view returns (uint256) {
        ...
        return (usdAmountInWei * PRECISION) / (uint256(price) * ADDITIONAL_FEED_PRECISION); // ($10e18 * 1e18) / ($2000e8 * 1e10)
    }
